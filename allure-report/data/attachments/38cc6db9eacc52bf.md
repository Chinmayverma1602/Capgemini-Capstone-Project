...
- Name: parabank_ui.spec.ts >> UI Test Cases >> TC-LOGIN-01 Verify special characters are not accepted in username
- Location: tests\parabank_ui.spec.ts:36:7
...
> 21 |     await this.page.fill('input[id="customer.firstName"]', userData.firstName);
  ...
  49 |   }
  50 | 
  51 |   async checkSpecialChar(){
  52 |     logger.info('This username already exists.');
  53 |     await expect(this.page.locator('span.id')).toContainText('This username already exists.')
  54 |   }
  55 | }
```