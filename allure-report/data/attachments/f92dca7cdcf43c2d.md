...
- Name: parabank_ui.spec.ts >> UI Test Cases >> TC-AC-UI-02 Mandatory Field Validation
- Location: tests\parabank_ui.spec.ts:88:5

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://parabank.parasoft.com/parabank/register.htm
Call log:
