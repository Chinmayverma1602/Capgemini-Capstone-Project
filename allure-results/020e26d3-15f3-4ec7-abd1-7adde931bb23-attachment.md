...
- Name: UI\parabank_UI.spec.ts >> UI Test Cases >> @ui @regression TC-AC-UI-02 Mandatory Field Validation
- Location: tests\UI\parabank_UI.spec.ts:54:7
...
Locator: locator('//span[@id=\'customer.firstName.errors\'], //span[@id=\'repeatedPassword.errors\']').first()
Expected substring: "First name is required."
SyntaxError: Failed to execute 'evaluate' on 'Document': The string '//span[@id='customer.firstName.errors'], //span[@id='repeatedPassword.errors']' is not a valid XPath expression.
...
Call log:
  ...
  - waiting for locator('//span[@id=\'customer.firstName.errors\'], //span[@id=\'repeatedPassword.errors\']').first()
