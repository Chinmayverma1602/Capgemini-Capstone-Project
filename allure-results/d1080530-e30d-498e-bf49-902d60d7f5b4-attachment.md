...
Error: strict mode violation: locator('text=Welcome') resolved to 2 elements:
    ...
    2) <h1 class="title">Welcome user1779085969767</h1> aka getByRole('heading', { name: 'Welcome user1779085969767' })
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e27]:
      - generic [ref=e28]:
        - paragraph [ref=e29]: Welcome David Smith
        ...
        - list [ref=e31]:
          ...
          - listitem [ref=e46]:
            - link "Log Out" [ref=e47] [cursor=pointer]:
              - /url: logout.htm
      - generic [ref=e48]:
        - heading "Welcome user1779085969767" [level=1] [ref=e49]
