...
- Name: performance-lite\uiPerformance.spec.ts >> UI Page Load Performance
- Location: tests\performance-lite\uiPerformance.spec.ts:6:5
...
```ts
  ...
  5  | 
  6  | test(
  7  | 'UI Page Load Performance',
  8  | async ({ page }) => {
  9  | 
  10 |   await page.goto(
  11 |     'http://localhost:9090/parabank'
  12 |   );
  13 | 
  14 |   const loadTime =
  ...
  16 | 
  17 |       const timing =
  18 |         performance.timing;
  19 | 
  20 |       return (
  21 |         timing.loadEventEnd -
  22 |         timing.navigationStart
  23 |       );
  24 |     });
  25 | 
  26 |   console.log(
  27 |     `UI Page Load Time:
  28 |     ${loadTime} ms`
  29 |   );
  30 | 
  31 |   expect(loadTime)
> 32 |     .toBeLessThan(5000);
     |      ^ Error: expect(received).toBeLessThan(expected)
  33 | 
  34 | });
```