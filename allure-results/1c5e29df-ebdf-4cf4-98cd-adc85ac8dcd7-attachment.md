...
- Location: tests\API\parabank_API.spec.ts:20:7
...
Call log:
  - → POST http://localhost:9090/parabank/services/bank/createAccount?customerId=12212&newAccountType=1&fromAccountId=12345
